...
namespace DeepMovie.DAL.Migrations
{
    ...
    [Migration("20220111194829_UserProfile")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DeepMovie.Common.Entities.UserProfile", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("DeepMovie.Common.Entities.UserProfile", b =>
                {
                    b.HasOne("DeepMovie.Common.Entities.User", "User")
                        .WithOne("UserProfile")
                        .HasForeignKey("DeepMovie.Common.Entities.UserProfile", "UserID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
