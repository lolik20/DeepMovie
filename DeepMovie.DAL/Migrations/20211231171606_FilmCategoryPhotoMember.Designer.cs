...
namespace DeepMovie.DAL.Migrations
{
    ...
    [Migration("20211231171606_FilmCategoryPhotoMember")]
    partial class FilmCategoryPhotoMember
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DeepMovie.Common.Entities.Photo", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("DeepMovie.Common.Entities.Member", b =>
                {
                    b.HasOne("DeepMovie.Common.Entities.Photo", "Photo")
                        .WithMany()
